...
$user_image_path = $user['user_image'] ? "../assets/images/avatar/logo.png" . $user['user_image'] : "img/logo.png"; // Fallback to default image
?>
...
<div class="dropdown nxl-h-item">
    ...
    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
        ...
        <a href="edit-akun.php" class="dropdown-item">
